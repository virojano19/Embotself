...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
                        ...
                        cl.sendText(msg.to,"[SELF BOT\[By.🌷✭₮Ӫℳ€↔βӪ₮₤ЇŊ€✭🌷 ]")
                        cl.sendText(msg.to,"[Do not think  will try.]")
                        ki1.sendText(msg.to,"[By.🌷✭₮Ӫℳ€↔βӪ₮₤ЇŊ€✭🌷]")
                        ki2.sendText(msg.to,"Hello " + str(ginfo.name) + "\n[ลิ้ง: http://line.me/ti/p/~tomebotline ]")
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                        G.preventJoinByTicket = True
                        ki1.updateGroup(G)
